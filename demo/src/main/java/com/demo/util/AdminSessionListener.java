 ...
 */
public class AdminSessionListener implements HttpSessionBindingListener {

	// 싱글톤 패턴
	private static AdminSessionListener sessionListener = null;
	
	public static synchronized AdminSessionListener getInstance() {
		if(sessionListener == null) {
			sessionListener = new AdminSessionListener();
		}
