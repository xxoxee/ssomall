...
public class AdBoardController {
	...
	public void writeNoticeGET() throws Exception {
		
		logger.info("=====writeNoticeGET() execute...");
	}
	
	/* 게시판 공지사항 쓰기(POST) */
	@RequestMapping(value="writeNotice", method=RequestMethod.POST)
	public String writeNotice(BoardVO vo, RedirectAttributes rttr) throws Exception {
		
		logger.info("=====writeNotice() execute...");
		logger.info("=====vo: "+vo.toString());
		
		service.writeNotice(vo);
		rttr.addFlashAttribute("msg", "WRITE_NOTICE_SUCCESS");
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="deleteNotice/{brd_num}", method=RequestMethod.POST, produces ="application/text; charset=utf8")
	public ResponseEntity<String> deleteNoticePOST(@PathVariable("brd_num") int brd_num) throws Exception {
